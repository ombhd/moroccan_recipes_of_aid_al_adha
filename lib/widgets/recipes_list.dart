...
class RecipesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  onTap: () {
                    Navigator.of(context).pushNamed(RecipeDetailsPage.routeName,
    ...
    else if (items.length == 0 && showOnlyFavorites)
      return Center(
        child: Text(
          'لا توجد لديك أي وصفات مفضلة حاليا ..',
          style: theme.textTheme.headline6!
